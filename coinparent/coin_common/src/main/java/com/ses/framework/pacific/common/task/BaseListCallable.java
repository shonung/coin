...
public abstract class BaseListCallable<T> extends BaseCallable<List<T>> implements Callable<List<T>> {
  public BaseListCallable() {
    setTaskCompleteListener(getListener());
  }

  public abstract ITaskCompleteListener<List<T>> getListener();
