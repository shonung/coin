...
public class StockStatusCollector implements IStatusCollector {
  
  private static final StockStatusCollector instance = new StockStatusCollector();
  
  private StockStatusCollector() {
    
  }
  
  public static StockStatusCollector getInstance() {
    return instance;
  }
