...
public class KorbitCoinBuyer extends CoinBuyer {
  private static final String TAG = KorbitCoinBuyer.class.getSimpleName();

  public KorbitCoinBuyer(CoinInfo coinInfo, ICheckerStatusListener listener) {
