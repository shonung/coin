...
public class KorbitCoinCheckerManager {
  private static final String TAG = KorbitCoinCheckerManager.class.getSimpleName();
  ...
  public KorbitCoinCheckerManager(MarketInfo marketInfo) {
